# Updated script version for Blender 4.0
    ...
    for mat in selected_object.data.materials:
        ...
        for node in mat.node_tree.nodes:
            if node.type == 'BSDF_PRINCIPLED':
                emissive_strength = node.inputs['Emission Strength']
                if emissive_strength.default_value != 0.0:
                    emissive_strength.default_value = visible_emissive_strength

                specular_input = node.inputs['Specular IOR Level']
